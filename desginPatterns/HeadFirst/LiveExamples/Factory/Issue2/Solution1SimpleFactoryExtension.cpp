...
//The First solution we can think is. we allow factories like AHDFactories,VizFactories responible for
//Creating The Screens for Paritcular Region We shall look the problem in NextFile
